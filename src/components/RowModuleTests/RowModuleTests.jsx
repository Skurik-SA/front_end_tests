                ...
                <section className={styles.textInfo}>
                    {is_closed
                        ...
                        <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <defs>
                                <filter id="filter0_f_716_46" x="0" y="0" width="30" height="30" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                        ...
                        <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M10 19.9999L20.0003 9.99998" stroke="black" stroke-width="2.5"/>
                            <path d="M10 10.0001L20.0003 20" stroke="black" stroke-width="2.5"/>
                            <defs>
                                <filter id="filter0_f_716_42" x="0" y="0" width="30" height="30" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                                    <feFlood flood-opacity="0" result="BackgroundImageFix"/>
                                    <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape"/>
