    ...
    const makeRegistration = (event) => {
        ...
        if (password1 !== '' || password2 !== '' || username !== '') {
            if (password1 === password2) {
                const resp = AuthApi.fetch_register(username, password1)
                    .then(response => {
                        if (response.ok) {
                            navigate("/login")
                        }
                            ...
                            <div>
                                <div>
                                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <path d="M29 29H11V15H29V29Z" stroke="black"/>
                                        <path d="M16 12V15H24V12L22.8571 9L21.7143 8H18.2857L17.1429 9L16 12Z" stroke="black"/>
                                        <path d="M26 6.54545L29.6 11L34 4" stroke="#0DA82F" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                                    </svg>
